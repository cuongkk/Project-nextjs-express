          ...
          <div className="contain">
            <div className="flex gap-[20px] lg:flex-nowrap flex-wrap relative ">
              ...
              <div className="lg:w-[65%] w-[100%]">
                ...
                {/* Mô tả chi tiết */}
                <div className="flex flex-col gap-[10px] border border-[#DEDEDE] rounded-[8px] p-[20px] mt-[20px]">
                  <div className="flex flex-row items-center gap-x-[8px]">
                    <label htmlFor="">Vị trí</label>
                    <div className="inline-block bg-[#F0F0F0] text-[#414042] text-[14px] font-[400] py-[4px] px-[8px] rounded-[8px] mr-[4px]">{jobDetail.position}</div>
                  </div>
                  <div className="flex flex-row items-center gap-x-[8px]">
                    <label htmlFor="">Công nghệ</label>
                    <div>
                      {jobDetail.technologies.map((tech: string, index: number) => (
                        <div key={index} className="inline-block bg-[#F0F0F0] text-[#414042] text-[14px] font-[400] py-[4px] px-[8px] rounded-[8px] mr-[4px]">
                          {tech}
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="flex flex-row items-center gap-x-[8px]">
                    ...
                    <div className="inline-block bg-[#F0F0F0] text-[#414042] text-[14px] font-[400] py-[4px] px-[8px] rounded-[8px] mr-[4px]">{jobDetail.workingForm}</div>
                  </div>

                  <div className="mt-[30px]" dangerouslySetInnerHTML={{ __html: jobDetail.description }} />
                </div>
                {/* Hết Mô tả chi tiết */}
              </div>
              {/* Right */}
